...
def load_page(url):
    ...
    cookie = "guid=56db-07ca-4e87-f04a; key=bfe31f4e0fb231d29e1d3ce951e2c780; UM_distinctid=16712ac667d18b-0c2f90b5be927-b79183d-100200-16712ac667fa8b; cna=I13fEQPsO0ICAd9XIcqaeqnA; _uab_collina=154220655304732961312653; CNZZDATA1255626299=1772599595-1542204043-https%253A%252F%252Fwww.baidu.com%252F%7C1542209444; x5sec=7b22617365727665723b32223a226132623637383233613761323231643335366564656533623434353533343637434d5361736438464550545467594755344a47517377453d227d; isg=BHZ2md1RMS1tIcXJJJelmAtlx6y4P7q0PdcFpuBfYtn0Ixa9SCcK4dzVP7_qi7Lp"
...
def main():
    ...
    for i in range(1, 35):
        ...
        url = 'https://www.amap.com/service/poiInfo?query_type=TQUERY&pagesize=200&pagenum=' + str(i) + '&qii=true&cluster_state=5&need_utd=true&utd_sceneid=1000&div=PC1000&addr_poi_merge=true&is_classify=true&zoom=12&geoobj=104.022648%7C30.548945%7C104.218685%7C30.775752&city=510100&keywords=%E8%8A%B1%E5%BA%97'
...
def write_list_to_excel(list):
    ...
    wbk.save("成都" + str(today_date) + '.xls')
